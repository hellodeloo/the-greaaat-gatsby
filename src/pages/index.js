        ...
        <div className="wrapper">
          ...
          <a href="#content" className="next-slide">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" enable-background="new 0 0 100 100">
              <path className="next-slide__arrow" stroke="#E7384A" stroke-width="2" stroke-linecap="round" stroke-miterlimit="10" fill="none" d="M62 24l-12 12-12-12"/>
            </svg>
          </a>
        </div>
      </div>
        ...
        <ul className="list-reset skills">
          <li className="skills__item">
            <h3 className="title-small">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32">
                <g stroke="#6F5B76" stroke-width=".5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none">
                  <path d="M19.9 6.2h2.6M19.9 10.1h2.6M19.9 14.1h2.6M19.9 18h2.6M19.9 21.9h2.6M19.9 25.8h2.6"/>
                </g>
                <g stroke="#6F5B76" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none">
                  <path d="M4.3 24.8h7.8"/>
                  <path stroke-width=".5" d="M4.3 22.9h7.8M8.2 9.4c0 1-.9 1.9-1.9 1.9s-1.9-.9-1.9-1.9M12.1 9.4c0 1-.9 1.9-2 1.9s-1.9-.9-1.9-1.9M6.2 11.3v11.6M10.1 11.3v11.6M6.2 5.7h3.9"/>
                </g>
                <g stroke="#6F5B76" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none">
          ...
          <li className="skills__item">
            <h3 className="title-small">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32">
                <g stroke="#6F5B76" stroke-miterlimit="10" fill="none">
          ...
          <li className="skills__item">
            <h3 className="title-small">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32">
                <path stroke="#6F5B76" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M28 26h-24c-1.1 0-2-.9-2-2v-16c0-1.1.9-2 2-2h24c1.1 0 2 .9 2 2v16c0 1.1-.9 2-2 2z" fill="none"/>
                <path stroke="#6F5B76" stroke-width=".5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none" d="M2 11.4h28"/>
                ...
                <path stroke="#6F5B76" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M13.3 21.1M17.6 15.4M13.3 21.1M17.1 15.4" fill="none"/>
              </svg>
              Intégrateur web
            </h3>
          ...
          <li className="skills__item">
            <h3 className="title-small">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32">
                ...
                <path stroke="#6F5B76" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M13.3 21.1M17.6 15.4M13.3 21.1M17.1 15.4" fill="none"/>
                <path stroke="#6F5B76" stroke-width=".5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none" d="M4.1 15.4h8.9v6.8h-8.9zM4.1 15.4l8.9 6.7M13 15.4l-8.9 6.7"/>
                <g stroke="#6F5B76" stroke-width=".5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none">
          ...
          <li className="skills__item">
            <h3 className="title-small">
              <svg className="icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32">
                <path stroke="#6F5B76" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none" d="M16 17.7l-12-5 12-5 12 5zM7.7 14.2v5.7c0 1.3 3.7 4.4 8.3 4.4s8.3-3.1 8.3-4.4v-5.7"/>
                <g stroke="#6F5B76" stroke-width=".5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none">
